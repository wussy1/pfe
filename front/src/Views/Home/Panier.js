...
const Panier = ({ navigation }) => {
  ...
  async function makeCommand(){
    ...
    axios
      .post(
        `http://192.168.103.80:5000/api/comd/add`
      ,{
        "products": cart,
      ...
      .then(() => getPanier().then(()=>{navigation.navigate('Navigation');ToastAndroid.show("Commande passé avec success", ToastAndroid.SHORT);}))
  )}
  ...
  async function getPanier() {
    await getUserData().then((res) =>
      axios
        .get(
          `http://192.168.103.80:5000/api/pan/by-user-id/${JSON.parse(res).id}`
        )
  ...
  async function PlusItem(idpanier, idproduit) {
    await axios
      .post("http://192.168.103.80:5000/api/pan/plus", {
        id_panier: idpanier,
        id_prod: idproduit,
      })
      .then(() => getPanier());
  ...
  async function MinusItem(idpanier, idproduit) {
    ...
    await axios
      .post("http://192.168.103.80:5000/api/pan/minus", {
        id_panier: idpanier,
        id_prod: idproduit,
      })
      .then(() => getPanier());
            ...
            <View>
              ...
              <View style={styles.shippingView}>
                ...
                <View style={styles.shippingItemsView}>
                  ...
                  >
                    <Text style={styles.shippingItemText}>Express (60 TND)</Text>
